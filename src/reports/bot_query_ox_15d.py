...
def get_fortnightly_report():
    ...
    try:
        ...
        query = "SELECT nome_estrutura, oxigenio, timestamp_site FROM leituras WHERE timestamp_site >= ? ORDER BY timestamp_site ASC"
        ...
        parecer_ia = analyze_custom_report_sync(
            "Relatório Quinzenal de Oxigênio (15 Dias)", 
            msg, 
        ...
        logger.info("Relatório de O2 (15 dias) enviado para o Telegram.")
