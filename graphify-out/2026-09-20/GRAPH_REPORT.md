...
### Community 1 - "main.py"
Cohesion: 0.07
Nodes (72): asyncio, CallbackQuery, Exception, InlineKeyboardMarkup, Message, Pool, criar_lote_completo(), finalizar_lote_abate() (+64 more)
...
## Knowledge Gaps
- **192 isolated node(s):** `aliases.sh script`, `11-backup-db.sh script`, `PGPASSWORD`, `02-setup-venv.sh script`, `03-install-python-deps.sh script` (+187 more)
...
- **Why does `get_sqlite_connection()` connect `get_sqlite_connection` to `app.py`, `get_weather_forecast`, `monitor_data.py`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `NoctuaClient` connect `NoctuaClient` to `app.py`, `monitor_data.py`?**
