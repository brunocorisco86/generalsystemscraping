...
def test_get_weather_forecast(mock_client_class):
    ...
    # Simular variáveis (0: temp, 1: humidity, 2: pressure)
    var0 = MagicMock()
    ...
    mock_current.Variables.side_effect = [var0, var1, var2]
    ...
    mock_hourly.Variables.side_effect = [h_var0, h_var1, h_var2, h_var3, h_var4]
